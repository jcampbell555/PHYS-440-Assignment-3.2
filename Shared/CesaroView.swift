...
//
//  Created by Joshua Campbell  on 2/18/22.
//
...
struct CesaroView: View {
    ...
    //added shit
    @Binding var meanFPFromParent: Int?
    @Binding var EnergyIFromParent: Int?
    @Binding var EnergyLossFromParent: Int?
...
//        Return the view with input numbers. View is blank if values are bad.
            return AnyView(
                CesaroFractalShape(iterations: newIterations!, piAngleDivisor: newPiAngleDivisor!, EnergyI: EnergyI! , EnergyLoss: EnergyLoss! , meanFP: meanFP! , InitH: InitH! )
...
struct CesaroFractalShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        var y: CGFloat = 0
        //550
        //CAN DIRECTLY CHANGE SIZE OF BOX HERE
        let size: Double = 300
...
//        CesaroPoints = CesaroFractalCalculator(x: x, y: y, size: size, angleDivisor: piAngleDivisor)
//
        
        CesaroPoints = ParticleWalk(EnergyI: EnergyI, EnergyLoss: EnergyLoss, meanFP: meanFP, InitH: Double(InitH), boxSizeX: x, boxSizeY: y)
...
//
//    //Added shit
//    @State static var meanFP :Int? = 1
//    @State  var EnergyI :Int? = 100
//    @State static var EnergyLoss :Int? = 10
//
//    static var previews: some View {
//
//
//        CesaroView(iterationsFromParent: $iterations, angleFromParent: $angle, meanFPFromParent: $meanFP, EnergyIFromParent: $EnergyI, EnergyLossFromParent: $EnergyLoss)
//
//    }
//}
